...
const BUTTON_TEXT = {
	...
	[SCORE_STATS]:
		"Show some charts breaking down the way your timeline is being scored when looked at in deciles.",
...
export default function ExperimentalFeatures() {
	...
	const showAlgoState = () => {
		...
		algorithm
			...
			.catch((error) =>
				logAndSetError(logger, `Failed to get algorithm state!`, error),
			)
