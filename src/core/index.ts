...
export default class TheAlgorithm {
     ...
     */
    async mergeExternalStatuses(statuses: mastodon.v1.Status[], source: TootSource): Promise<void> {
    ...
    async triggerFederatedTimelineMerge(limit: number = 40): Promise<void> {
        const statuses = await MastoApi.instance.getFederatedTimelineStatuses(limit);
