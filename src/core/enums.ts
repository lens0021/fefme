...
export const DAYS_SHORT = DAY_NAMES.map((day) =>
	day.slice(0, day.startsWith("T") ? 4 : 3),
);
 ...
 */
export function buildCacheKeyDict<
	K extends string,
	T,
	D extends Optional<Record<K, T>>,
>(
...
export const isWeightName = (str: string) =>
	isScoreName(str) || isNonScoreWeightName(str);
